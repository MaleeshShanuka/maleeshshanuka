...
const XIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83-8.22-9.01h7.487l5.28 7.073L18.901 1.153Zm-1.65 19.33h2.61l-10.59-12.08L6.03 2.5h-2.58l10.8 12.4-1.18 1.58h-.14l-1.54-1.54Z" />
  </svg>
)
