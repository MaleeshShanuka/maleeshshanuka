...
const XIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.409 617.62L119.833 43.4216H312.21L604.223 519.497L651.979 589.699L1091.01 1184.05H898.63L569.165 687.854V687.828Z"
      fill="currentColor"
    />
  </svg>
)
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <div className="flex space-x-4 pt-4">
            ...
            <Link href="https://x.com/MaleeshShanuka" target="_blank" rel="noopener noreferrer">
              <XIcon className="h-8 w-8 text-foreground/70 hover:text-primary transition-colors" />
            </Link>
